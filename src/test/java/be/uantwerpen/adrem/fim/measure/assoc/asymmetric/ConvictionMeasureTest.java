...
public class ConvictionMeasureTest extends RuleMeasureTestBase {
	...
	public void test_empty_set() {
		assertEquals(1.0, m.evaluate(sEmpty, s0), delta);
		assertEquals(1.0, m.evaluate(sEmpty, s01), delta);
		assertEquals(1.0, m.evaluate(sEmpty, s012), delta);
		assertEquals(1.0, m.evaluate(sEmpty, s47), delta);
		assertEquals(1.0, m.evaluate(sEmpty, s56), delta);
	}
	...
	public void test_set_set_include() {
		assertEquals(9.0 / 5.0, m.evaluate(s0, s012), delta);
		assertEquals(9.0 / 5.0, m.evaluate(s01, s012), delta);

		assertEquals(POSITIVE_INFINITY, m.evaluate(s012, s0), delta);
		assertEquals(POSITIVE_INFINITY, m.evaluate(s012, s01), delta);
	}

	@Override
	@Test
	public void test_set_set_overlap() {
		assertEquals(4.5 / 5.0, m.evaluate(s0, s56), delta);

		assertEquals(4.5 / 5.0, m.evaluate(s01, s56), delta);

		assertEquals(4.0 / 5.0, m.evaluate(s56, s0), delta);
		assertEquals(4.0 / 5.0, m.evaluate(s56, s01), delta);
	}

	@Override
	@Test
	public void test_set_set_no_overlap() {
		assertEquals(4.0 / 5.0, m.evaluate(s0, s47), delta);

		assertEquals(4.0 / 5.0, m.evaluate(s01, s47), delta);

		assertEquals(4.0 / 5.0, m.evaluate(s012, s47), delta);
		assertEquals(3.0 / 5.0, m.evaluate(s012, s56), delta);

		assertEquals(2.0 / 5.0, m.evaluate(s47, s0), delta);
		assertEquals(2.0 / 5.0, m.evaluate(s47, s01), delta);
		assertEquals(3.0 / 5.0, m.evaluate(s47, s012), delta);
		assertEquals(3.0 / 5.0, m.evaluate(s47, s56), delta);

		assertEquals(3.0 / 5.0, m.evaluate(s56, s012), delta);
		assertEquals(4.0 / 5.0, m.evaluate(s56, s47), delta);
	}
}

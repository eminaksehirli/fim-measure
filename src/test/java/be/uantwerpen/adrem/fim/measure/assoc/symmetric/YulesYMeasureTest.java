...
public class YulesYMeasureTest extends RuleMeasureTestBase {
	...
	public void test_set_set_overlap() {
		assertEquals((1 - sqrt(2)) / (1 + sqrt(2.0)), m.evaluate(s0, s56),
				delta);

		assertEquals((1 - sqrt(2)) / (1 + sqrt(2.0)), m.evaluate(s01, s56),
				delta);

		assertEquals((1 - sqrt(2)) / (1 + sqrt(2.0)), m.evaluate(s56, s0),
				delta);
		assertEquals((1 - sqrt(2)) / (1 + sqrt(2.0)), m.evaluate(s56, s01),
				delta);
	}

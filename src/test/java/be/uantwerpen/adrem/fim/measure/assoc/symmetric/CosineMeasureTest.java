 ...
 */
public class CosineMeasureTest extends RuleMeasureTestBase {

	private CosineMeasure m;

	@Override
	@Before
	public void setUp() {
		super.setUp();
		m = new CosineMeasure(db);
	}
	...
	public void test_empty_set() {
		assertEquals(sqrt(3.0 / 5.0), m.evaluate(sEmpty, s0), delta);
		assertEquals(sqrt(3.0 / 5.0), m.evaluate(sEmpty, s01), delta);
		assertEquals(sqrt(2.0 / 5.0), m.evaluate(sEmpty, s012), delta);
		assertEquals(sqrt(1.0 / 5.0), m.evaluate(sEmpty, s47), delta);
		assertEquals(sqrt(2.0 / 5.0), m.evaluate(sEmpty, s56), delta);
	}

	@Override
	@Test
	public void test_set_empty() {
		assertEquals(sqrt(3.0 / 5.0), m.evaluate(s0, sEmpty), delta);
		assertEquals(sqrt(3.0 / 5.0), m.evaluate(s01, sEmpty), delta);
		assertEquals(sqrt(2.0 / 5.0), m.evaluate(s012, sEmpty), delta);
		assertEquals(sqrt(1.0 / 5.0), m.evaluate(s47, sEmpty), delta);
		assertEquals(sqrt(2.0 / 5.0), m.evaluate(s56, sEmpty), delta);
	}
	...
	public void test_set_set_include() {
		assertEquals(2.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s0, s012),
				delta);
		assertEquals(2.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s01, s012),
				delta);

		assertEquals(2.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s012, s0),
				delta);
		assertEquals(2.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s012, s01),
				delta);
	}
	...
	public void test_set_set_overlap() {
		assertEquals(1.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s0, s56), delta);

		assertEquals(1.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s01, s56),
				delta);

		assertEquals(1.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s56, s0), delta);
		assertEquals(1.0 / (5.0 * sqrt(6.0 / 25.0)), m.evaluate(s56, s01),
				delta);
	}

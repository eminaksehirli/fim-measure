...
public class ProbabilityTest
{
	...
	{
		Assert.assertEquals(NaN, P_NOT_A_GIVEN_NOT_B(sEmpty, sEmpty, size), delta);
		...
		Assert.assertEquals(2.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s0, s012, size), delta);
		Assert.assertEquals(1.0 / 4.0, P_NOT_A_GIVEN_NOT_B(s0, s47, size), delta);
		Assert.assertEquals(1.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s0, s56, size), delta);
		...
		Assert.assertEquals(2.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s01, s012, size), delta);
		Assert.assertEquals(1.0 / 4.0, P_NOT_A_GIVEN_NOT_B(s01, s47, size), delta);
		Assert.assertEquals(1.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s01, s56, size), delta);
		...
		Assert.assertEquals(2.0 / 4.0, P_NOT_A_GIVEN_NOT_B(s012, s47, size), delta);
		Assert.assertEquals(1.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s012, s56, size), delta);

		Assert.assertEquals(NaN, P_NOT_A_GIVEN_NOT_B(s47, sEmpty, size), delta);
		Assert.assertEquals(1.0 / 2.0, P_NOT_A_GIVEN_NOT_B(s47, s0, size), delta);
		Assert.assertEquals(1.0 / 2.0, P_NOT_A_GIVEN_NOT_B(s47, s01, size), delta);
		Assert.assertEquals(2.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s47, s012, size), delta);
		Assert.assertEquals(1.0, P_NOT_A_GIVEN_NOT_B(s47, s47, size), delta);
		Assert.assertEquals(2.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s47, s56, size), delta);

		Assert.assertEquals(NaN, P_NOT_A_GIVEN_NOT_B(s56, sEmpty, size), delta);
		Assert.assertEquals(1.0 / 2.0, P_NOT_A_GIVEN_NOT_B(s56, s0, size), delta);
		Assert.assertEquals(1.0 / 2.0, P_NOT_A_GIVEN_NOT_B(s56, s01, size), delta);
		Assert.assertEquals(1.0 / 3.0, P_NOT_A_GIVEN_NOT_B(s56, s012, size), delta);
		Assert.assertEquals(2.0 / 4.0, P_NOT_A_GIVEN_NOT_B(s56, s47, size), delta);

...
public class CertaintyFactorMeasureTest extends RuleMeasureTestBase {
	...
	public void test_set_set_include() {
		assertEquals((2.0 / 3.0 - 2.0 / 5.0) / (1 - 2.0 / 5.0),
	...
	public void test_set_set_overlap() {
		assertEquals((1.0 / 3.0 - 2.0 / 5.0) / (1 - 2.0 / 5.0),
				m.evaluate(s0, s56), delta);

		assertEquals((1.0 / 3.0 - 2.0 / 5.0) / (1 - 2.0 / 5.0),
				m.evaluate(s01, s56), delta);

		assertEquals((1.0 / 2.0 - 3.0 / 5.0) / (1 - 3.0 / 5.0),
	...
	public void test_set_set_no_overlap() {
		assertEquals((-1.0 / 5.0) / (1 - 1.0 / 5.0), m.evaluate(s0, s47), delta);

		assertEquals((-1.0 / 5.0) / (1 - 1.0 / 5.0), m.evaluate(s01, s47),
				delta);

		assertEquals((-1.0 / 5.0) / (1 - 1.0 / 5.0), m.evaluate(s012, s47),
				delta);
		assertEquals((-2.0 / 5.0) / (1 - 2.0 / 5.0), m.evaluate(s012, s56),
				delta);

		assertEquals((-3.0 / 5.0) / (1 - 3.0 / 5.0), m.evaluate(s47, s0), delta);
		assertEquals((-3.0 / 5.0) / (1 - 3.0 / 5.0), m.evaluate(s47, s01),
				delta);
		assertEquals((-2.0 / 5.0) / (1 - 2.0 / 5.0), m.evaluate(s47, s012),
				delta);
		assertEquals((-2.0 / 5.0) / (1 - 2.0 / 5.0), m.evaluate(s47, s56),
				delta);

		assertEquals((-2.0 / 5.0) / (1 - 2.0 / 5.0), m.evaluate(s56, s012),
				delta);
		assertEquals((-1.0 / 5.0) / (1 - 1.0 / 5.0), m.evaluate(s56, s47),
				delta);
